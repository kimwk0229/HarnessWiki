...
| 액션아이템 롤업 | `wiki/action-items.md` | `wiki/action-items/action-items.md` |
...
```
wiki/action-items/action-items.md
...
- `wiki/action-items.md` → `wiki/action-items/action-items.md`
...
- **라인 40-42**: 토픽 간 링크 및 롤업 링크 예시 갱신
  ...
  - `../action-items.md` → `../../action-items/action-items.md`
